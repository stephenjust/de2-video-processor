...
create_driver genesis_driver

# Associate it with some hardware
set_sw_property hw_class_name genesis

# The version of this driver is "1"
...
# C/C++ source files
add_sw_property c_source HAL/src/genesis.c

# Include files
add_sw_property include_source HAL/inc/genesis.h
